...
protected:
  void set_properties();
  bool only_set_properties; // the item doesn't need full fix_fields
public:
  ...
  Item_ref(Name_resolution_context *context_arg,
    ...
    only_set_properties(0), result_field(0), ref(0), reference_trough_name(1) {}
  /*
  ...
  */
  ...
  Item_ref(THD *thd, Item_ref *item)
    :Item_ident(thd, item), only_set_properties(0), result_field(item->result_field), ref(item->ref) {}
